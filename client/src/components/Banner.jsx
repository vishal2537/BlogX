...
const Banner = ({ post }) => {
  return (
    <div className="w-full mb-10">
      <div className="relative w-full h-[500px] 2xl:h-[600px] flex  px-0 lg:px-7 ">
        ...
        <div className="absolute flex flex-col md:right-10 bottom-10 md:bottom-2 w-full md:w-2/4 lg:w-1/3 2xl:w-[480px] bg-white dark:bg-[#05132b] shadow-2xl p-5 rounded-lg gap-3 hover:scale-110 transition duration-500 cursor-pointer">
          ...
          <Link
            ...
            className="w-fit bg-rose-400 bg-opacity-20 text-rose-700 px-4 py-1 rounded-full text-sm cursor-pointer "
          >
            Read more...
          </Link>
