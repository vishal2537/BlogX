...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white dark:bg-[#020b19]  flex flex-col md:flex-row w-full py-5  items-center justify-between gap-4 md:gap-0 sticky top-0 z-50 ">
      <Logo />
      <div className="hidden md:flex gap-14 items-center">
        <ul className="flex gap-10 text-base text-black dark:text-white">
          <Link to="/">Home</Link>
          <Link to="/">About</Link>
          <Link to="/">Contact</Link>
