...
export const posts = [
  {
    ...
    desc:
      ...
      "        Hello World\n" +
      "    &lt;/div&gt;\n" +
      ' */</code></pre><p style="text-align: start">HTML attributes can also be overridden, with a <a target="_blank" rel="noopener ugc nofollow" className="af lw" href="https://github.com/probablyup/markdown-to-jsx#usage"><u>few exceptions</u></a>.</p><h2 style="text-align: start"><strong>HTML is a-ok.</strong></h2><p style="text-align: start">Most markdown parsers steer clear of handling HTML and ones targeting JSX often have to resort to using <code>dangerouslySetInnerHTML</code>, an escape hatch that opens up your code to various security risks.</p><p style="text-align: start"><code>markdown-to-jsx</code> itself had to utilize this functionality in an earlier version, but as of v6 that is no longer the case! It’s all good now.</p><h2 style="text-align: start"><strong>Github-Flavored Markdown (GFM) syntaxes are supported.</strong></h2><p style="text-align: start">GFM <a target="_blank" rel="noopener ugc nofollow" className="af lw" href="https://github.github.com/gfm/"><u>adds a ton of useful functionality</u></a> to markdown like HTML tables, task lists, strikethrough formatting, and more.</p><p style="text-align: start">—</p><p style="text-align: start">All this weighs in at <a target="_blank" rel="noopener ugc nofollow" className="af lw" href="https://bundlephobia.com/result?p=markdown-to-jsx%406.0.3"><u>just over 5kB gzipped</u></a>.</p><p style="text-align: start">Special thanks are owed to the <a target="_blank" rel="noopener ugc nofollow" className="af lw" href="https://github.com/Khan/simple-markdown"><u>simple-markdown</u></a> team for creating an extremely simple, but highly-extensible markdown framework. A forked version of their parsing engine is the baseline for all the functionality above and much more to come. 🙏🏼</p><p style="text-align: start"><em>Check out my other project: </em><a target="_blank" rel="noopener ugc nofollow" className="af lw" href="https://buttermilk.js.org/"><u>buttermilk</u></a>, beautifully simple routing for React</p>',
    img: "https://th-thumbnailer.cdn-si-edu.com/NaExfGA1op64-UvPUjYE5ZqCefk=/fit-in/1600x0/filters:focal(1471x1061:1472x1062)/https://tf-cmsv2-smithsonianmag-media.s3.amazonaws.com/filer/b6/30/b630b48b-7344-4661-9264-186b70531bdc/istock-478831658.jpg",
    cat: "CODING",
    views:
      Array(50)[
    ...
    user: {
      ...
      name: "Tony Stark",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPr8_3ianZ13-PStHqWLKnTGo0qc3MDsEJ5eCS8K9rc1dhUAM21nVs6NvK_-DQhskcVOk&usqp=CAU",
    },
  ...
  },
  {
    ...
    img: "https://remeng.rosselcdn.net/sites/default/files/dpistyles_v2/rem_16_9_1124w/2019/09/02/node_90310/11025832/public/2019/09/02/B9720758527Z.1_20190902095137_000%2BG60EC4O3D.1-0.jpg?itok=76Sl03zR1567410703",
    cat: "FASHION",
    views:
      Array(23)[
...
export const popular = {
  ...
  writers: [
    ...
    },
    {
      ...
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfM835ud9BPD14l7RYdG40D5nS9VIL2NDRgA&usqp=CAU",
      followers: 1,
    },
  ],
};
